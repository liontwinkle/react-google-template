                ...
                <div className="col">
                    <div className="ht-100p mt-2">
                        ...
                        <ul className="list-group list-group-flush tx-13">
                            ...
                            <li className="list-group-item d-flex pd-sm-x-20">
                                <div className="avatar d-none d-sm-block"><span className="avatar-initial rounded-circle bg-orange op-5"><i className="icon ion-md-bus"></i></span></div>
                                <div className="pd-sm-l-10">
                            ...
                            <li className="list-group-item d-flex pd-sm-x-20">
                                <div className="avatar d-none d-sm-block"><span className="avatar-initial rounded-circle bg-gray-400"><i className="icon ion-md-close"></i></span></div>
                                <div className="pd-sm-l-10">
                                    <p className="tx-medium mg-b-0">image.png</p>
                        ...
                        <div className="card-footer text-center tx-13">
                            <a href="#viewall" className="link-03">View All Files <i className="icon ion-md-arrow-down mg-l-5"></i></a>
                        </div>
                    </div>
                </div>
            </div>
