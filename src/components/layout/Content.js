    ...
    <div className="home-slider">
      <div className="home-lead">
        ...
        <div className="tx-12 mg-t-40">
          ...
          <a href="https://themeforest.net/licenses/standard" target="_blank" className="link-03 mg-l-10 mg-sm-l-20" rel="noopener noreferrer">Licenses</a>
          <a href="https://themeforest.net/page/customer_refund_policy" target="_blank" className="link-03 mg-l-10 mg-sm-l-20" rel="noopener noreferrer">Refund Policy</a>
        </div>
      </div>
